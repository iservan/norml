	 ...
	 if(!is_admin()) {
	  ...
	  function scripts() {	
	   ...
	   wp_register_script('custom_script', URL . '/js/custom.js', array('jquery'), '0.1' );
	    wp_enqueue_script('jquery-ui', URL . '/js/jquery-ui-1.8.14.custom.min.js', array('jquery'), '0.1' );
	 // Important scripts
                      ...
                      <div class="description <?php echo $width;?> ">
                         <?php if($title_below) { ?>     <h2 class="<?php echo $custom_font; ?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2> <?php } ?>
                            <?php if($extras) { ?>  
							 ...
							 <li class="date"><?php echo get_the_time("d")." ".get_the_time("M")." ".get_the_time("Y"); ?></li>                             <li class="tags">                            
                            <?php 
							        if($show_tags)
									  {
										  ...
										  foreach($tags as $tag)
										  {
											  $ptag .= "<a href='".get_tag_link($tag->term_id)."'>".$tag->name."</a>, ";
										  }
									  }
									  echo $ptag;
							?>
