...
class Enchance
{
	...
	public function enableUnlimitedSidebars()
	{
        ...
        <!--     <input type="checkbox" value="true" name="enable_sidebar" <?php if($enable_sidebar=="true") echo"checked='checked'"; ?> />
            --> 
     ...
     <label for="sidebar_no">No</label><input type="radio" id="sidebar_no" name="enable_sidebar" value="false" <?php if($enable_sidebar=="false") echo "checked='checked'"; ?>/>
             ...
             <input type="hidden" value="<?php echo admin_url(); ?>" id="h_admin_url" />
			</div>
