...
$video_code = '<?xml version="1.0" encoding="UTF-8"?>
<data>
	<settings>
		<cWidth>940</cWidth><!-- Native size : 300 -->
		<cHeight>450</cHeight><!-- Native size : 250 -->
		...
		<playlist usePlaylist = "true" nAlpha = "1.0" oAlpha = "1.0" txtTop = "8" txtLeft = "10" top = "0" left = "0" signTop = "11" signLeft = "3" hitAreaH = "26">PLAYLIST</playlist>
 ...
 $wp_query = new WP_Query("post_type=video&posts_per_page=-1");
	 $flag = "true";
while ( $wp_query->have_posts() ) : $wp_query->the_post();
	...
	if (isset($blog_id) && $blog_id > 0) {
	 ...
	 $video_code .= '<video startWithMe = "'.$flag.'">
					<title>'.get_the_title().'- For more details goto '.get_permalink().'</title>
					<vidURL fit = "fitToSizeForced">'.$link.'</vidURL>
				     <thumbnail loaderColor = "0xB2B2B2"
		fit="fitToFill"
		frameNalpha = "0.2"
		frameOalpha = "1"
		frameSalpha = "0.5"
		frameNcolor = "0xffffff"
		frameOcolor = "0x6699ff"
		frameScolor = "0xffffff"
		frameThickness = "2">'.get_bloginfo('template_directory')."/timthumb.php?src=".urlencode($theImageSrc).'&h=250&w=250 </thumbnail>
				</video>';
	 $flag = "false";
endwhile;		
