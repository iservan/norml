         ...
         <div class="slide-body">
          ...
          <div class="image-slide slide-panels"> 
           <div class="separator clearfix">
            ...
            <div class="separator clearfix">
                <label for="">Image Link:</label>
                <input type="text" class="inputs" name="link_src[]" value="" />
           </div>
              <div class="separator clearfix">
                <label for="">Slide Title:</label>
                <input type="text" class="inputs" name="title[]" value="" />
           </div>
            <div class="lseparator clearfix">     
                <label for="">Description:</label>
                <textarea  cols="30" rows="10" class="inputs" name="description[]"></textarea>
           </div>   
